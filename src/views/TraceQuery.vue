...
/* .dark-json >>> .jv-key[data-type]:hover::after {
  content: attr(data-type) "\A" attr(data-desc);
  position: absolute;
  bottom: 100%;
  left: 50%;
...
.dark-json >>> .jv-key[data-type]:hover::before {
...
.dark-json >>> .jv-key[data-desc]:hover::after {
...
.dark-json >>> .jv-key[data-type="输入"]:hover::before {
  background: #f6c042;
  color: #0a0909;
}

.dark-json >>> .jv-key[data-type="输出"]:hover::before {
  background: #7ad55c;
  color: #0a0909;
}

.dark-json >>> .jv-key[data-type="系统参数"]:hover::before {
  background: #e0e7e0;
  color: #221f1f;
}
